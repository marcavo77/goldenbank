      ...
      <div ref={messagesContainerRef} className="flex-1 overflow-y-auto p-4 space-y-4 custom-scrollbar bg-slate-800/50">
        ...
        <div className="flex justify-start">
             <div className="flex items-end gap-2 max-w-[85%]">
                <div className="w-6 h-6 rounded-full bg-teal-400 flex items-center justify-center shrink-0 text-white text-xs font-bold shadow-lg">G</div>
        ...
        {myMessages.map((msg, index) => {
            ...
            return (
                <React.Fragment key={msg.id}>
                    ...
                    <div className={`flex ${msg.senderId === currentUser.id ? 'justify-end' : 'justify-start'}`}>
                        {msg.senderId !== currentUser.id && (
                             <div className="w-6 h-6 rounded-full bg-teal-400 flex items-center justify-center shrink-0 text-white text-xs font-bold shadow-lg mr-2 self-end">G</div>
                        )}
